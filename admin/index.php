...
<body>
    <div class="container">
        ...
        <div class="row ">
            ...
            <div class="col-md-9">
                <div class="float-end mt-5 me-4"><a href="?log=logout">  logout </a></div>
                <div class="float-end mt-5 me-4" > User : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser'] ?>"> <?php echo $_SESSION['user'] ?> </a> </div>
                <div class="float-end mt-5 me-4"><a href="?log=logout">LEVEL: <?php echo $_SESSION['level'] ?> </a></div>
            </div>
        </div>
